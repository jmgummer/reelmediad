...
/**
 * This is the model class for table "mediaJournalist".
 *
 * The followings are the available columns in table 'mediaJournalist':
 ...
 */
class MediaJournalist extends CActiveRecord
{
	/**
	...
	public static function JournalistName(){
		$sql = 'select journalistID, firstname, surname,othername 
				from mediaJournalist';
		// return CHtml::listData(MediaJournalist::model()->findAllBySql($sql));
	}
}
