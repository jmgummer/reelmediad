...
/**
 * This is the model class for table "mediajournalist2".
 *
 * The followings are the available columns in table 'mediajournalist2':
 * @property integer $journalistID
 * @property string $firstname
 * @property string $surname
 * @property string $othername
 * @property string $journalistType
 * @property string $mapped_ids
 */
class Mediajournalist2 extends CActiveRecord
{
	/**
	 ...
	 * @return Mediajournalist2 the static model class
	 */
	public static function model($className=__CLASS__)
	{
	 ...
	 public function getJournalistName(){
        ...
        $journalists = mediajournalist2::model()->findAll(array('order'=>'firstname'));
