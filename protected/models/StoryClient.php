...
/**
 * This is the model class for table "story_client".
 *
 * The followings are the available columns in table 'story_client':
 * @property integer $auto_id
 * @property integer $story_id
 * @property integer $client_id
 */
class StoryClient extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return StoryClient the static model class
	 */
