...
class Swfviewer{
    ...
    <strong class="cmention">Companies Mentioned : </strong><font class="cmention">'.substr($array->CompanyMentions, 0, -2).'</font></span>';
	}

  public static function GetSwfTitles($array){
    return '<span class="style3"><p><strong>'.$array->Title.'</strong></p><br><hr class="simple"></hr>';
  }
